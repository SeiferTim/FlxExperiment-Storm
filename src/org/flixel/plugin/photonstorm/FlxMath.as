...
package org.flixel.plugin.photonstorm 
{
	...
	public class FlxMath
	{
		...
		/**
		 * checks if a number is between two numbers. in case you're not sure which is higher
		 */
		public static function isBetween(Value:Number, Bound1:Number, Bound2:Number):Boolean
		{
			var min:Number = FlxU.min(Bound1, Bound2);
			var max:Number = FlxU.max(Bound1, Bound2)
