package org.flixel
{
	...
	public class FlxCamera extends FlxBasic
	{
		...
		public function get flashOffsetX():Number
		{
			return _flashOffsetX;
		}
		public function get flashOffsetY():Number
		{
			return _flashOffsetY;
		}
		
		
		public function centerInStage():void
		{
			_flashOffsetX = (width*0.5*zoom);
			_flashOffsetY = (height*0.5*zoom) ;
			
			/*
			FlxG.camera.screen.setOriginToCorner();
			_flashOffsetX = FlxG.stage.stageWidth * 0.5;//(width*0.5*zoom);
			_flashOffsetY = FlxG.stage.stageHeight * 0.5;//(height*0.5*zoom) ;
			FlxG.camera.screen.setOriginToCorner();
			*/
		}
