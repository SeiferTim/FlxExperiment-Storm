...
package org.flixel.plugin.photonstorm 
{
	...
	public class FlxCollision 
	{
		...
		public static function pixelPerfectPointCheckBitmapData(pointX:uint, pointY:uint, target:BitmapData, alphaTolerance:int = 255):Boolean
		{
			//	Intersect check
			...
			//	How deep is pointX/Y within the rect?
			var test:BitmapData = target;
			
			if (FlxColor.getAlpha(test.getPixel32(pointX, pointY)) >= alphaTolerance)
			{
				return true;
			}
			else
