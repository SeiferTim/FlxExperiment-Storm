package org.flixel
{
	...
	public class FlxG
	{
		...
		static private var _canPause:Boolean = true;
		
		static public var zoomLevel:Number;
		...
		static public function set canPause(Value:Boolean):void
		{
			 
			_game.canPause = _canPause = Value;
		}
	}
}
